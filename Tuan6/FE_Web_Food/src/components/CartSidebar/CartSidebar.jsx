...
import { taoHoaDon } from '../../data/orderApi';
...
const CartSidebar = () => {
    ...
    const handleCheckout = async () => {
        try {
            ...
            const duLieuUser = localStorage.getItem("user");
            if (!duLieuUser) {
            ...
            const user = JSON.parse(duLieuUser);
            ...
            const hoaDon = await taoHoaDon(requestBody);
            console.log(hoaDon);
            // lưu hóa đơn để trang checkout dùng lại
            localStorage.setItem("currentOrder", JSON.stringify(hoaDon));
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="flex items-center gap-3 mt-2">
                                                    <div className="flex items-center border border-border">
                                                        ...
                                                        <span className="px-3 text-xs font-body">
                                                            {item?.quantity}
                                                        </span>
                        ...
                        {items?.length > 0 && (
                            <div className='border-t border-border p-6 space-y-4'>
                                ...
                                <motion.button
                                    ...
                                    disabled={dangTaoHoaDon}
                                    className='w-full bg-foreground text-background font-body text-sm tracking-widest uppercase py-4 flex items-center justify-center gap-2 hover:bg-accent hover:text-accent-foreground transition-colors duration-300 cursor-pointer disabled:opacity-60'
                                >
                                    {dangTaoHoaDon ? "Đang tạo hóa đơn..." : "Checkout"}
                                    <ArrowRight size={16} />
                                </motion.button>
                            </div>
                        )}
