        ...
        <section className='relative w-full h-[70vh] min-h-[400px] overflow-hidden'>
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
                ...
                <motion.button
                    ...
                    whileHover={{scale: 1.05}}
                    whileTap={{scale: 0.95}}
                    className='bg-orange-500 text-white text-sm tracking-widest uppercase px-8 py-3 rounded-full hover:bg-orange-600 transition-all duration-300 cursor-pointer'
                >
                    Order Now
                </motion.button>
